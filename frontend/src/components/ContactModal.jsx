            ...
            {!isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                    <div className="contact-input-group">
                      <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', marginBottom: '0.5rem', marginLeft: '0.5rem' }}>Full Name</label>
                      <input 
                    ...
                    <div className="contact-input-group">
                      <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', marginBottom: '0.5rem', marginLeft: '0.5rem' }}>Email Address</label>
                      <input 
                  ...
                  <div className="contact-input-group">
                    <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', marginBottom: '0.5rem', marginLeft: '0.5rem' }}>Subject</label>
                    <input 
                  ...
                  <div className="contact-input-group">
                    <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', marginBottom: '0.5rem', marginLeft: '0.5rem' }}>Message</label>
                    <textarea 
              ...
              >
                <div style={{ 
                  ...
                  color: '#10b981', marginBottom: '2rem'
                }}>
                  <CheckCircle size={40} />
                </div>
                <h2 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '1rem' }}>Thank You!</h2>
                <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1.2rem', lineHeight: '1.6', marginBottom: '2.5rem', maxWidth: '400px' }}>
                  Your message has been sent successfully. We will get back to you soon.
                </p>
                <button 
                  onClick={resetForm}
                  style={{
                    padding: '0.9rem 2.5rem', borderRadius: '12px', background: 'rgba(255, 255, 255, 0.08)',
